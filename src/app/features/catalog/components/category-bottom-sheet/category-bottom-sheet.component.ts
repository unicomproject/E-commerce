...
@Component({
  ...
  standalone: true,
  imports: [RouterModule, NgIconComponent, LoadingSpinnerComponent, NgOptimizedImage],
  viewProviders: [
    provideIcons({ lucideX, lucideChevronDown, lucideChevronRight, lucideArrowLeft, lucideImage }),
  ],
